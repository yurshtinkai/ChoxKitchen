...
export const HamburgerMenuOverlay = ({
  ...
  const handleItemClick = (item) => {
    // Always call onClick if provided (this handles React Router navigation)
    if (item.onClick) {
      item.onClick();
    }

    // Fallback to href navigation if no onClick handler
    ...
    // Close menu after navigation (unless keepOpenOnItemClick is true)
      ...
      <style>
        {`
          ...
          @media (max-width: 768px) {
            ...
            .hamburger-overlay-${zIndex} {
              clip-path: circle(0px at ${buttonLeft} 30px);
            }
            
            .hamburger-overlay-${zIndex}.open {
              clip-path: circle(150% at ${buttonLeft} 30px);
            }
        ...
        {customButton || (
          <div className="relative w-full h-full flex items-center justify-center">
            ...
            <svg
              ...
              width={buttonSize === "sm" ? 16 : buttonSize === "md" ? 20 : 24}
              height={buttonSize === "sm" ? 16 : buttonSize === "md" ? 20 : 24}
              viewBox="0 0 24 24"
              fill="none"
              stroke={textColor}
              strokeWidth="2"
